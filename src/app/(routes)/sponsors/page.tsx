        ...
        <div
          ...
          <div className="flex flex-col items-center justify-between gap-7 w-full h-full">
            ...
            <p className="text-center text-slate-300 text-sm md:text-base">
              ...
              headquartered in Denmark. EG is 44 years old in the market and
              globally we are 2200+ employees and 30000+ clients. EG has more
              than 100+ products in the Nordic region. We have our customers in
              the Nordic region and delivery centre in India, Poland, Iceland,
              Denmark, Sweden, Finland, and Norway. In India we are 180+ as of
              now and looking forward to building a team of 300+ employees in
              the coming year. In Mangalore we are in Bejai, Kapikad Ajanta
              Business centre.
            </p>
        ...
        <div
          ...
          <div className="flex flex-col items-center justify-between gap-7 w-full h-full">
            ...
            <p className="text-center text-slate-300 text-sm md:text-base">
              ...
              the students. We spread our services throughout the continents. We
              welcome you to study in Canada, Australia, UK, USA, Europe, and
              many more. Our job service is planned for students who wish to
              study and settle abroad. We market the profiles of our students to
              various universities in which he/she wants to study.
            </p>
            <a
