...
export default function Contact() {
  return (
    <main
      className="bg-gradient-to-b from-[#060e3c] via-[#052d4f] to-[#001933] flex justify-start flex-col items-center min-h-screen mx-auto pt-20 sm:pt-20 md:pt-24 xl:pt-28 p-2 sm:p-6 md:p-10 xl:p-20 pb-8"
      style={{
        background:
    ...
    >
      ...
      <div className="flex flex-col md:gap-10 gap-5 justify-center items-center">
        <div className="flex md:gap-24 gap-3 flex-wrap justify-center items-center w-full">
