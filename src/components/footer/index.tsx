         ...
         <Image
          ...
          <ul className="flex  gap-4 md:gap-4">
            ...
            <div className='flex flex-col items-center gap-8'>
              ...
              <p className='text-base font-normal text-center'>Interested to sponsor? Let us know <Link href='mailto:sponsor@hackfest.dev' className='underline'>sponsor@hackfest.dev</Link></p>
            </div>
         </div>
