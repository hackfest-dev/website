...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col w-full px-4 h-80 border-t border-gray-700 bg-gradient-to-b from-slate-900 to-slate-950  backdrop-blur-md">
      <div className='flex flex-row h-full items-center justify-evenly'>
         ...
         <Image
              ...
              <Image
                className=" border-2 border-gray-600 rounded-2xl p-1"
              ...
              />
              <Image
                className=" border-2 border-gray-600 rounded-2xl p-2"
          ...
          <ul className="flex  gap-4 md:gap-4">
            ...
            <div className='flex flex-col items-center'>
              <div className='flex flex-row items-center justify-center gap-8'>
                <div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3884.6730533394866!2d74.93141407492217!3d13.183002587152156!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbb56415ad85e5b%3A0x10b77ac6f6afc7fa!2sN.M.A.M.%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1705002903689!5m2!1sen!2sin" width="200" height="100"  style={{border:0}} className='rounded-lg' aria-hidden="false"></iframe>
                </div>
                <div className='flex flex-col'><h1>NMAM Institute of Technology, Nitte</h1>
                <p>Karkala, Udupi District, Karnataka</p>
                </div>
              </div>
              <p>Interested to sponsor? Let us know <Link href='mailto:sponsor@hackfest.dev'>sponsor@hackfest.dev</Link></p>
            </div>
         </div>
