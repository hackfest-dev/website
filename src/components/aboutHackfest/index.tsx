    ...
    <>
      <div className="grid grid-rows-6 lg:grid-cols-1 lg:min-h-screen p-12 transition-all">
        <div className="flex items-center justify-center lg:justify-start row-span-1">
          <h1 className="text-5xl text-center font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent">
            About Hackfest
          </h1>
        </div>
        <div className="grid row-span-5 lg:grid-cols-10 gap-4">
          <div className="grid grid-rows-2 lg:col-span-3 h-full">
            <BorderedContainer className="p-5 w-full grid grid-cols-12 h-full rounded-3xl">
              <div className="col-span-11 flex flex-col justify-center items-center">
                <h1 className="text-6xl font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent">
                  &nbsp;APRIL
                </h1>
              ...
              <div className="col-span-1 flex flex-col items-center justify-center font-bold text-xl bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent">
                <span>2</span>
                <span>0</span>
                <span>2</span>
                <span>4</span>
            ...
            <BorderedContainer className="w-full flex flex-col justify-start p-8 px-12 space-y-4 rounded-3xl">
              <h1 className="text-4xl font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent">
                5 Tracks
              </h1>
          ...
          <div className="grid lg:grid-cols-2 lg:col-span-7 lg:gap-4 border border-gray-200 rounded-3xl p-4 gap-12">
            <div className="border h-96 lg:h-full border-gray-200 rounded-3xl text-4xl font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent">
              <iframe
            ...
            <div className="grid grid-rows-11 gap-4 h-screen lg:h-full">
              <BorderedContainer className="w-full flex items-center justify-center rounded-3xl p-4 py-6 text-2xl  xl:text-3xl text-center font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent">
                3 Day Long Tech-Fest
              </BorderedContainer>
              <BorderedContainer className="w-full flex flex-col row-span-4  rounded-3xl text-7xl text-center font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent p-4 justify-center items-center">
              ...
              <div className="flex flex-col items-center justify-center row-span-1 text-lg text-center font-bold bg-gradient-to-r from-base-300 to-supporting-500 bg-clip-text text-transparent xl:text-xl">
