    ...
    <>
      ...
      >
        ...
        <div className="h-screen sticky top-0 flex overflow-x-clip">
          ...
          <div
            id="timeline"
            className="absolute right-full top-1/2 w-[150vw] h-[150vw] min-w-[36rem] min-h-[36rem] max-w-7xl max-h-[80rem] translate-x-1/2 -translate-y-1/2 overflow-hidden flex justify-center items-center"
          >
            {/* Wheel */}
            {/* <motion.div
              style={{
          ...
          <div className="absolute left-full top-1/2 w-[150vw] h-[150vw] min-w-[36rem] min-h-[36rem] max-w-7xl max-h-[80rem] lg:-translate-x-[75%] xl:-translate-x-[100%] md:-translate-x-[62%] -translate-x-[60%] -translate-y-1/2 overflow-hidden flex justify-center items-center">
            {/* Wheel */}
            <div className="flex flex-col justify-center items-center gap-5">
              <h1 className="lg:text-8xl text-7xl font-obscura md:block hidden">
                Day{" "}
