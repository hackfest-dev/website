    ...
    <div className="bg-slate-900 h-full p-12 w-full">
      ...
      <div className="mt-16">
        {speakerData.map((data,index)=>{
            return <div className="flex flex-col md:flex-row justify-center items-center mt-16 md:mt-12 border-gray-700 rounded-2xl p-4 max-w-6xl mx-auto bg-gradient-to-tl from-primary to-slate-950 shadow-xl shadow-gray-950" key={index}>
          ...
          <div className="flex flex-col justify-center w-full gap-4">
            ...
            <div className="flex flex-col md:flex-row justify-between md:justify-evenly items-center gap-4">
              <h2 className="border-2 w-full md:w-1/3 border-gray-500 rounded-lg text-lg font-medium p-1">{data.speakerName}</h2>
              <h2 className="border-2 w-full md:w-1/3 border-gray-500 rounded-lg text-lg font-medium p-1">{data.designation}</h2>
            </div>
          </div>
        </div>
        })}
