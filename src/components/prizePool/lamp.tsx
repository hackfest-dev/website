...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0  flex w-full flex-col-reverse items-center justify-center overflow-hidden rounded-md bg-slate-950",
        className,
      )}
    >
      <motion.div
      ...
      <div className="relative isolate z-0 flex w-full scale-y-125 items-center justify-center ">
        ...
        <div className="h-50 absolute top-1/2 w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
