      ...
      <div className="z-0  w-full flex flex-col items-center justify-center rounded-md py-10 md:py-16 xl:py-20 gap-6 md:gap-10 bg-slate-950 overflow-clip">
        ...
        >
          <FadeIn className="order-2 md:order-1 z-[1]" delay={0.3}>
            <div className="w-72 h-72 shadow-xl bg-gradient-to-r from-base-800 via-base-700 to-base-800 border border-gray-800 rounded-lg z-10 md:translate-x-5 pb-4 flex flex-col gap-4 justify-center items-center">
          ...
          <FadeIn className="order-1 md:order-2 z-[2]">
            <div className="w-72 h-72 md:w-80 md:h-80 shadow-xl  bg-gradient-to-r from-base-800 via-base-700 to-base-800 border border-gray-800 rounded-lg z-20 md:relative pb-4 flex flex-col gap-4 justify-center items-center">
