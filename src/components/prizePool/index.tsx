      ...
      <div id="prizes" className="z-0  w-full flex flex-col items-center justify-center rounded-md py-10 md:py-16 xl:py-20 gap-6 md:gap-10 bg-slate-950 overflow-clip">
        ...
        >
          <FadeIn className="order-2 md:order-1 z-[1]" delay={0.3}>
            <div className="w-72 h-72 shadow-xl bg-gradient-to-r from-base-800/65 via-base-700/65 to-base-800/65 border border-gray-800 rounded-lg z-10 md:translate-x-5 pb-4 flex flex-col gap-4 justify-center items-center  backdrop-blur-md">
          ...
          <FadeIn className="order-1 md:order-2 z-[2]">
            <div className="w-72 h-72 md:w-80 md:h-80 shadow-xl  bg-gradient-to-r from-base-800/65 via-base-700/65 to-base-800/65 backdrop-blur-md border border-gray-800 rounded-lg z-20 md:relative pb-4 flex flex-col gap-4 justify-center items-center">
          ...
          <FadeIn className="order-3 md:order-3 z-0" delay={0.6}>
            <div className="w-72 h-72 shadow-xl bg-gradient-to-r from-base-800/65 via-base-700/65 to-base-800/65 backdrop-blur-md border border-gray-800 rounded-lg z-10 md:-translate-x-5 pb-4 flex flex-col gap-4 justify-center items-center">
              <h1 className="font-bold text-xl text-white  relative">
                Second Runner Up
              </h1>
              <p className="font-normal text-base text-slate-500   text-center ">
        ...
        <LampContainer className="pt-5 md:pt-7">
          ...
          <FadeIn delay={0.4}>
            <p className="font-normal text-xs text-slate-500 text-center mt-4">
