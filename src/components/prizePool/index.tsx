      ...
      >
        ...
        >
          ...
          <FadeIn className="order-1 md:order-2 z-[2]">
            <div className="bg-gradient-to-br from-teal-700/50 via-teal-300/50 to-teal-700/50 backdrop-blur-2xl border-2 border-teal-600 rounded-2xl w-72 h-72 md:w-80 md:h-80 shadow-xl  bg-gradient-to-r from-base-800/65 via-base-700/65 to-base-800/65 backdrop-blur-sm border border-gray-800 rounded-lg z-20 md:relative pb-4 flex flex-col gap-4 justify-center items-center">
          ...
          <FadeIn className="order-3 md:order-3 z-0" delay={0.6}>
            <div className="bg-gradient-to-br from-teal-700/50 via-teal-300/50 to-teal-700/50 backdrop-blur-2xl border-2 border-teal-600 rounded-2xl w-72 h-72 shadow-xl bg-gradient-to-r from-base-800/65 via-base-700/65 to-base-800/65 backdrop-blur-sm border border-gray-800 rounded-lg z-10 md:-translate-x-5 pb-4 flex flex-col gap-4 justify-center items-center">
              <h1 className="font-bold text-xl text-white  relative">
                Second Runner Up
              </h1>
              <p className="font-normal text-base text-slate-200   text-center ">
